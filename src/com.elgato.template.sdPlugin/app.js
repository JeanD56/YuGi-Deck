...
// Fonction pour jouer le son de décrémentation en boucle
function playDecrementSoundLoop() {
    decrementSound.loop = true;
    decrementSound.play();
}

// Fonction pour arrêter le son de décrémentation
...
// Fonction pour décrémenter les points de vie d'un joueur
function decrementLife() {
    // Code pour décrémenter les points de vie
    // ...

    // Jouer le son de décrémentation en boucle
    playDecrementSoundLoop();

    // Après un certain délai, arrêter le son de décrémentation et jouer le son de fin de tour
    setTimeout(function () {
        stopDecrementSound();
        playEndTurnSound();
